...
#define RS 							GPIOD, PIN0
#define RW  						GPIOD, PIN1
#define E   						GPIOD, PIN2

//------ LCD DATA Pin Definition 
#define LCD_D0 	GPIOA, PIN0
#define LCD_D1 	GPIOA, PIN1
#define LCD_D2 	GPIOA, PIN2
#define LCD_D3 	GPIOA, PIN3
#define LCD_D4 	GPIOA, PIN4
#define LCD_D5 	GPIOA, PIN5
#define LCD_D6  GPIOA, PIN6
#define LCD_D7  GPIOA, PIN7

#define LCD_DATA_BUFFER		GPIOA
